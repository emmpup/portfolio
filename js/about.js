...
async function generateCardsFromData() {
  try {
    ...
    cardsData.forEach((cardData) => {
      ...
      backImg.src = "./img/about/cardBack.png";
      backImg.alt = "Card Back";
      backImg.className = "card__back__image";
      ...
      frontImg.alt = cardData.title + " Image";
      frontImg.className = "card__front__image";
      frontImg.loading = "lazy";
      cardFront.appendChild(frontImg);

      const textContainer = document.createElement("div");
      textContainer.className = "card__front__text-container";

      const title = document.createElement("h3");
      title.className = "card__front__title";
      title.textContent = cardData.title;
      textContainer.appendChild(title);

      const description = document.createElement("p");
      description.className = "card__front__text";
...
document.addEventListener("DOMContentLoaded", generateCardsFromData);
